...
async function testResultCaching() {
  ...
  // Allow 2ms tolerance for timer granularity on CI runners
  assert(time2 <= time1 + 2, `Cached call (${time2}ms) should not be significantly slower than first call (${time1}ms)`);
