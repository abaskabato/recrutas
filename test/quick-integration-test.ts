 ...
 * Run with: npx tsx test/quick-integration-test.ts
 */
 ...
 */
function calculateMatchScore(candidateSkills: string[], job: any) {
 ...
 */
function generateJobFeed(candidateSkills: string[], jobs: any[]): JobMatch[] {
  return jobs
    .map(job => {
...
async function runTests() {
  ...
  try {
    ...
    console.log('  Parsing resume with AI (fallback mode - no API key)...');
